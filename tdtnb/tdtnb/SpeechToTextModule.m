...
- (void)postByteData:(NSData *)byteData {
    ...
    NSString *urlString = [NSString stringWithFormat:@"https://www.google.com/speech-api/v2/recognize?xjerr=1&client=chromium&lang=zh-CN&key=%@",GOOGLE_SPEECH_TO_TEXT_KEY];
