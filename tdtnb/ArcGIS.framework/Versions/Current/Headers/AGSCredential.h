...
/** Whether or not requests that use this credential should go over HTTPS.
 @since 2.2
 */
 ...
 */
+ (NSURL*)getTokenServiceUrl:(NSURL *)url;
 ...
 */
+ (AGSAuthenticationType)isServiceSecured:(NSURL*)url;
